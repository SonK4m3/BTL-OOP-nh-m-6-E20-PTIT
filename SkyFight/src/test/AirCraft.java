...
//	int column = 3;
	...
	public void initImage() {
		try {
			this.north_image = ImageIO.read(new File("D:\\Code\\test\\Swing\\Major-Assignment-OOP-Group-6-E20-PTIT\\SkyFight\\image\\aircraft\\north.png")); 
			this.east_image = ImageIO.read(new File("D:\\Code\\test\\Swing\\Major-Assignment-OOP-Group-6-E20-PTIT\\SkyFight\\image\\aircraft\\east.png")); 
			this.south_image = ImageIO.read(new File("D:\\Code\\test\\Swing\\Major-Assignment-OOP-Group-6-E20-PTIT\\SkyFight\\image\\aircraft\\south.png")); 
			this.west_image = ImageIO.read(new File("D:\\Code\\test\\Swing\\Major-Assignment-OOP-Group-6-E20-PTIT\\SkyFight\\image\\aircraft\\west.png")); 
		} catch(IOException e) {
			e.getMessage();
		}
	}
